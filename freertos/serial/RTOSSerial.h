...
#ifndef __RTOS_SERIAL_H__
#define __RTOS_SERIAL_H__

// disable the stock Arduino serial driver
#ifdef HardwareSerial_h
# error Must include RTOSSerial.h before the Arduino serial driver is defined.
#endif
...
///
/// RTOSSerialPort(<port name>, <port number>)
///
...
///
/// RTOSSerialPort0(<port name>)         creates <port name> referencing serial port 0
/// RTOSSerialPort1(<port name>)         creates <port name> referencing serial port 1
/// RTOSSerialPort2(<port name>)         creates <port name> referencing serial port 2
/// RTOSSerialPort3(<port name>)         creates <port name> referencing serial port 3
///
...
//@{
extern class RTOSSerial Serial;
extern class RTOSSerial Serial1;
extern class RTOSSerial Serial2;
extern class RTOSSerial Serial3;
//@}

/// The RTOSSerial class definition
///
class RTOSSerial: public BetterStream {
public:

	/// Constructor
	RTOSSerial(const uint8_t portNumber, volatile uint8_t *ubrrh, volatile uint8_t *ubrrl, volatile uint8_t *ucsra,
...
///
#define RTOSSerialHandler(_PORT, _RXVECTOR, _TXVECTOR, _UDR, _UCSRB, _TXBITS) \
...
///
/// Macro defining a RTOSSerial port instance.
///
#define RTOSSerialPort(_name, _num)                                     \
	RTOSSerial _name(_num,                                          \
                         &UBRR##_num##H,                                \
                         &UBRR##_num##L,                                \
                         &UCSR##_num##A,                                \
                         &UCSR##_num##B,                                \
...
///
/// Compatibility macros for previous RTOSSerial versions.
///
...
/// defined at all.
///
#define RTOSSerialPort0(_portName)     RTOSSerialPort(_portName, 0)
#define RTOSSerialPort1(_portName)     RTOSSerialPort(_portName, 1)
#define RTOSSerialPort2(_portName)     RTOSSerialPort(_portName, 2)
#define RTOSSerialPort3(_portName)     RTOSSerialPort(_portName, 3)

#endif // __RTOS_SERIAL_H__
